        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="photo" placeholder="Photo">{{ $trainer->photo }}</textarea>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="roll" placeholder="Roll">{{ $trainer->roll }}</textarea>
